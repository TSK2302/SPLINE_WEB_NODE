  ...
  return (
    <main className='relative w-full h-screen overflow-hidden flex justify-center mb-[10%]'>
        <video src='public\videos\hero.mp4'
            ...
            muted
            playsInline
            className='w-full h-[95%] object-cover absolute top-0 first-letter:left-0 -z-10'></video>
            ...
            <div className='absolute bottom-[15%] flex flex-col items-center gap-5 '>
                ...
                <div className='md:w-[75%] w-[60%] h-[0.1] bg-[#baba]'></div>
                ...
                <p className='max-ww-[80%] text-center text-[#babaff]'>
